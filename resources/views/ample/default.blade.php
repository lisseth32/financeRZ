...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ asset('/css/style.min.css?v='.env('VERSION_CSS')) }}" rel="stylesheet">
</head>
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        @include('ample.header')

            @include('ample.sidebar')
    ...
    <script type="text/javascript">
        var url_eliminar = "{{ route('eliminar',[0]) }}";
        var url_editar = "{{ route('editar',[0]) }}";
    </script>
</body>
